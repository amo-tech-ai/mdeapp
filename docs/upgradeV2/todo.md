...
**Updated:** 2026-06-14 (docs [#220](https://github.com/amo-tech-ai/mdeapp/pull/220) merged @ `8b3f84ee` · code [#219](https://github.com/amo-tech-ai/mdeapp/pull/219) @ `4c6ef62e`) · **Mode:** `post-cutover · prod deploy + smoke`  
**Ground truth:** `main` @ **`8b3f84ee`** (docs #220 · 2026-06-14T13:29:04Z) · code cutover **`4c6ef62e`** (#219) · prior `078a677c` ([SAN-890 · CK-V2-004 — Migrate /chat (conciergeAgent) to v2 — last, highest-risk](https://linear.app/sanjiovani/issue/SAN-890/ck-v2-004-migrate-chat-conciergeagent-to-v2-last-highest-risk) #218)  
