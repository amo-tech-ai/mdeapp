...
description: Load when Mastra TypeScript errors suggest outdated API knowledge.
parent: mastra
impact: MEDIUM
impactDescription: Build, agent, and workflow error patterns
tags: mastra, errors, debugging
---
