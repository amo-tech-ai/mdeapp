---
title: Multi-agent systems — Mastra
description: Load when splitting work across multiple agents or combining agents + workflows. Conceptual; defer multi-agent in mdeapp Phase 1.
parent: mastra
impact: MEDIUM
impactDescription: Multi-agent architecture concepts
tags: mastra, agents, multi-agent
mdeapp: phase2-defer
---
