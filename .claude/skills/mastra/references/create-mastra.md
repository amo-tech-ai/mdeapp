---
title: Create Mastra projects
description: Load when scaffolding a new Mastra project or CLI layout.
parent: mastra
impact: MEDIUM
impactDescription: CLI quickstart and manual install paths
tags: mastra, scaffold, cli
---
