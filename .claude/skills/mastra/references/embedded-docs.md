---
title: Embedded package docs
description: Load when Mastra packages are installed and you need exact API shapes from node_modules.
parent: mastra
impact: HIGH
impactDescription: Version-accurate APIs under node_modules/@mastra
tags: mastra, embedded-docs, node_modules
---
