---
title: Remote mastra.ai docs
description: Load when Mastra packages are not installed and you need mastra.ai docs.
parent: mastra
impact: MEDIUM
impactDescription: Fetch guides when local packages missing or ahead-of-install
tags: mastra, docs, remote
---
