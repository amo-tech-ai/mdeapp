...
import { HostEventCopilotBridgeV2 } from "@/components/host/host-event-copilot-bridge-v2";
...
type HostEventShellV2Props = {
  userEmail?: string | null;
};

/**
 * SAN-889 · CK-V2-003 — v2 host event shell (flag on).
 * v1 host-event-shell.tsx unchanged for flag-off parity.
 */
export function HostEventShellV2({ userEmail }: HostEventShellV2Props) {
  return (
    <HostEventCopilotBridgeV2>
      {({ draft, setDraft }) => (
        <div
